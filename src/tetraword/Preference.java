...
public class Preference extends JFrame {
    ...
    public Preference(){  	    	
    	// cr�ation d'une instance de Properties
        ...
        bt_debutant.addMouseListener(new MouseAdapter() {
        	...
        	public void mouseClicked(MouseEvent e) {
        		...
        		expert = 0;
        		bt_debutant.setBorder(BorderFactory.createBevelBorder(BevelBorder.LOWERED));
            	/*Enregistrer une propri�t� dans le fichier de configurations */
    	...
    	// R�cup�rer une propri�t� d'un fichier de configurations
   	 	String configLevel = options.getProperty("Level"); // Trouve la valeur associ�e � la clef "Level"
        ...
        //Affichage des reglages
     	// R�cup�rer une propri�t� d'un fichier de configuration
        String configUniv = options.getProperty("Univers"); // Trouve la valeur associ�e � la clef "Univers"
        ...
        //Affichage des reglages
    	// R�cup�rer une propri�t� d'un fichier de configurations
   	 	String configDico = options.getProperty("Dictionary"); // Trouve la valeur associ�e � la clef "Dictionary"
